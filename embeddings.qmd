...
```{r, eval = F}
# ================================ create term (feature) co-occurrence matrix
# ================================
...
local_glove <- readRDS(url(url, method="libcurl"))
...
local_glove <- readRDS("data/local_glove.rds")
```
...
word <- local_glove["economy",, drop = FALSE]
